...
"}}}
" {{{ Colors
  let s:base00=['#1c1c1c', '235'] "['#2A373E', '235'] gray
  let s:base01=['#343d46', '237'] " gray
  let s:base02=['#4f5b66', '240'] " gray
  let s:base03=['#65737e', '243'] " gray
  let s:base04=['#a7adba', '145'] " gray
  let s:base05=['#dfe1e6', '251'] " gray
  let s:base06=['#cdd3de', '252'] " light gray
  let s:base07=['#d8dee9', '253'] " lighter gray
  let s:base08=['#ec5f67', '203'] " red
  let s:base09=['#F99B66', '209'] " salmon
  let s:base0A=['#fac863', '221'] " goldenrod
  let s:base0B=['#99c794', '114'] " pale green
  let s:base0C=['#62B3B2', '73'] " cadet blue (teal)
  let s:base0E=['#4284c7', '68'] " blue, should be s:base0D
  "let s:base0D=['#c594c5', '176'] purple, should be s:base0E
  let s:base0D=['#4284c7', '68'] 
